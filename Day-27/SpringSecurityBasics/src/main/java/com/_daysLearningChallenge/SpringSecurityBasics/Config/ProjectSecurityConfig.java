...
import com._daysLearningChallenge.SpringSecurityBasics.Filters.JWTTokenGeneratorFilter;
import com._daysLearningChallenge.SpringSecurityBasics.Filters.JWTTokenValidatorFilter;
...
public class ProjectSecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        /*
            No need to configure session when we use JWT based authentication and authorization
         ...
         */
            http.csrf((csrf)->csrf.csrfTokenRequestHandler(requestHandler)
                ...
                .requestMatchers("/notices","/contact","/register").permitAll())
                    ...
                    // generate jwt token after authentication process is completed
                    .addFilterAfter(new JWTTokenGeneratorFilter(),BasicAuthenticationFilter.class)

                    // after the generation of jwt token for every request made it should be validated before the authentication process
    ...
    public CorsFilter corsFilter() {
        ...
        config.addExposedHeader(String.valueOf(Arrays.asList("Authorization")));
